...
- [Data model diagram]
![database-design.png](screenshots/database-design.png)
- [AWS architecture diagram]
![aws-architecture.png](screenshots/aws-architecture.png)
- [AWS Cognito flow diagram]
![fetching-user.png](screenshots/fetching-user.png)
![saving-user.png](screenshots/saving-user.png)
![securing-api.png](screenshots/securing-api.png)
